...
By following these guidelines, you can effectively transform video transcripts into captivating and informative summaries, drawing in readers and conveying the video's essence effectively."""
            ...
            STRICT OUTPUT RULES:
            - ALWAYS use this exact format: [hh:mm:ss]({{url}}?t={{seconds}}) {{title}}
            - NEVER add extra text before/after timestamps
            - INCLUDE ALL these mandatory timestamps:
            1. [00:00:00]({{url}}?t=0) Introduction
            2. [{{end_time}}]({{url}}?t={{total_seconds}}) Conclusion

            EXAMPLE OUTPUT:
            1. [00:00:00](https://youtu.be/ABC123?t=0) Introduction
            2. [00:05:23](https://youtu.be/ABC123?t=323) Main Topic 1
            ...
